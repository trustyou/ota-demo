...
class SearchService(object):
    ...
    async def search(self, search_data: SearchRequest) -> SearchResponse:
        ...
        hotels_response = SearchServiceDataFeed.search(cluster_search_results)

        return hotels_response


class SearchServiceMock(object):
    async def search(self, _search_data: SearchRequest) -> SearchResponse:
        """
        Filter result from search_data
        ...
        :return: Mock data
        """
        hotels_response = SearchServiceDataFeed.search([], use_mock=True)
